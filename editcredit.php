...
include("include/nav.php");
 ...
 <?php
    ...
    $query = "SELECT * FROM `credit` WHERE `credit`.`id` = '$edit_id'";
      ...
      <div class="col-md-10">
        <div class="card">
          ...
          <div class="card-body" style="margin-left:50px;">
            <form class="" action="updatecredit.php" method="post">
              <div class="form-row">
             ...
             <div class="form-row">
               ...
               <input type="text" name="Given" value="<?=$given;?>" class="form-control">
             </div>
             <div class="">
